...
//            canvas.endMarkedContentSequence();
    ...
    private void addFooterCenter(PdfWriter writer){
        ...
        try {
            ...
            // add copyright
            footer.addCell(new Phrase("momra", new Font(Font.FontFamily.HELVETICA, 12, Font.BOLD)));
            ...
            Paragraph p=new Paragraph("page NO");
